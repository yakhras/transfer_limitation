...
class UnpaidInvoice(models.Model):
    ...
    partner_mail = fields.Many2one(related='invoice_id.partner_id.email', string="Email")
    partner_phone = fields.Many2one(related='invoice_id.partner_id.phone', string="Phone")
