...
class ResPartnerSaleReport(models.TransientModel):
    ...
    def action_generate_excel_report(self):
        ...
        worksheet.set_header('&LCompany: %s&CReport: Packing List&RPage &P of &N' % sale_order.company_id.name)
        worksheet.set_footer('&LGenerated by Odoo&CDate: &D Time: &T&RPage &P')
