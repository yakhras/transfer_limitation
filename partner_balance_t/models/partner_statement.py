...
# ==========================================
# 
# # Create partner statement
# partner_statement = env['partner.statement'].create({'partner_id': 123})
# 
# # Get complete statement
# statement_data = partner_statement.get_complete_partner_statement()
# 
# # Get specific data
# active_orders = partner_statement.get_active_sales_orders()
# uninvoiced = partner_statement.get_uninvoiced_products(active_orders)
# payments = partner_statement.get_invoice_payment_mapping()
# 
# ==========================================