...
class AccountMoveLineReport(models.Model):
    ...
    debit_amount = fields.Monetary(string='Debit Amount', compute='_compute_debit_amount', currency_field='currency_id', store=False, group_operator='sum')
    credit_amount = fields.Monetary(string='Credit Amount', compute='_compute_credit_amount', currency_field='currency_id', store=False, group_operator='sum')
