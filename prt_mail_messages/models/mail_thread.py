...
class MailThread(models.AbstractModel):
    ...
    def unlink(self):
        # Remove all messages related to record including trash messages
    ...
    def _notify_record_by_email(
        ...
        **kwargs,
        ...
        if self._context.get("default_wizard_mode", False) not in ["quote", "forward"]:
        ...
        signature_location = self._context.get("signature_location")
