odoo.define('pos_invoice_t.SalesSelectionPopup', function (require) {
    'use strict';
    ...
    // formerly SalesSelectionPopupWidget
    class SalesSelectionPopup extends AbstractAwaitablePopup {
        /**
    ...
    Registries.Component.add(SalesSelectionPopup);

    return SalesSelectionPopup;
});
